...
interface IPerpDataProvider {
    ...
    struct MarketData {
        ...
        uint256 minLiquidatorFee;
        uint256 maxLiquidatorFee;
        uint256 price;
        uint256 size;
        int256 skew;
        uint256 skewScale;
        ...
        uint256 burnAtTradePartOfTradeFee;
        uint256 feeReceiverPartOfTradeFee;
        uint256 feeReceiverPartOfLiquidationFee;
